...
/**
 * Write a description of class gota_de_mel_infetada here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class gota_de_mel_infetada extends Projeteis
{
    /**
    ...
    public gota_de_mel_infetada(boolean facingRight) {
